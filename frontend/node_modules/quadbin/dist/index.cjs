...
function getCellPolygon(quadbin, coverage) {
  if (coverage === void 0) {
    coverage = 1;
  }
  const [topLeft, bottomRight] = cellToWorldBounds(quadbin, coverage);
  const [w, n] = webMercator.worldToLngLat(topLeft);
  const [e, s] = webMercator.worldToLngLat(bottomRight);
...
exports.cellToOffset = cellToOffset;
exports.cellToParent = cellToParent;
exports.cellToTile = cellToTile;
exports.cellToWorldBounds = cellToWorldBounds;
exports.geometryToCells = geometryToCells;
exports.getCellPolygon = getCellPolygon;
exports.getResolution = getResolution;
exports.hexToBigInt = hexToBigInt;
exports.tileToCell = tileToCell;
