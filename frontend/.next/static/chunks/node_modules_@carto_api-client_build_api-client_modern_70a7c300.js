(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@carto_api-client_build_api-client_modern_70a7c300.js", {

"[project]/node_modules/@carto/api-client/build/api-client.modern.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "WidgetBaseSource": (()=>WidgetBaseSource),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$intersects$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/boolean-intersects/dist/esm/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$polygon$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/bbox-polygon/dist/esm/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$within$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/boolean-within/dist/esm/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$intersect$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/intersect/dist/esm/index.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/bbox-clip/dist/esm/index.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$union$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/union/dist/esm/index.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$equal$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@turf/boolean-equal/dist/esm/index.js [client] (ecmascript)");
;
;
;
;
...
(function(FilterType) {
    FilterType["IN"] = "in";
    /** [a, b] both are included. */ FilterType["BETWEEN"] = "between";
    /** [a, b) a is included, b is not. */ FilterType["CLOSED_OPEN"] = "closed_open";
    FilterType["TIME"] = "time";
    FilterType["STRING_SEARCH"] = "stringSearch";
})(FilterType || (FilterType = {}));
/** @privateRemarks Source: @carto/constants */ var ApiVersion;
(function(ApiVersion) {
    ApiVersion["V1"] = "v1";
    ApiVersion["V2"] = "v2";
    ApiVersion["V3"] = "v3";
})(ApiVersion || (ApiVersion = {}));
/** @privateRemarks Source: @carto/constants, @deck.gl/carto */ const DEFAULT_API_BASE_URL = 'https://gcp-us-east1.api.carto.com';
/** @privateRemarks Source: @carto/react-core */ var TileFormat;
(function(TileFormat) {
    TileFormat["MVT"] = "mvt";
...
/** @privateRemarks Source: @carto/react-core */ var SpatialIndex;
(function(SpatialIndex) {
    SpatialIndex["H3"] = "h3";
    SpatialIndex["S2"] = "s2";
    SpatialIndex["QUADBIN"] = "quadbin";
})(SpatialIndex || (SpatialIndex = {}));
/** @privateRemarks Source: @carto/react-core */ var Provider;
(function(Provider) {
 ...
 */ function _buildFeatureFilter({ filters = {}, type = 'boolean', filtersLogicalOperator = 'and' }) {
...
function geojsonFeatures({ geojson, spatialFilter, uniqueIdProperty }) {
    let uniqueIdx = 0;
    const map = new Map();
    if (!spatialFilter) {
        return [];
    ...
    for (const feature of geojson.features){
        ...
        if (!map.has(uniqueId) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$intersects$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(spatialFilter, feature)) {
 ...
 */ function transformToTileCoords(geometry, bbox) {
    ...
    const nw = projectFlat([
        west,
        north
    ]);
    const se = projectFlat([
        east,
        south
    ]);
    const projectedBbox = [
...
function tileFeaturesGeometries({ tiles, tileFormat, spatialFilter, uniqueIdProperty, options }) {
    const map = new Map();
    for (const tile of tiles){
        ...
        const bboxToGeom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$polygon$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(bbox);
        const tileIsFullyVisible = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$within$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(bboxToGeom, spatialFilter);
        ...
        const clippedGeometryToIntersect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$intersect$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["featureCollection"])([
            bboxToGeom,
            spatialFilterFeature
        ]));
...
function processTileFeatureProperties({ map, data, startIndex, endIndex, type, bbox, tileFormat, uniqueIdProperty, storeGeometry, geometryIntersection }) {
    ...
    if (geometry && geometryIntersection && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$intersects$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometry, geometryIntersection)) {
        return;
    }
...
function addIntersectedFeaturesInTile({ map, data, geometryIntersection, type, bbox, tileFormat, uniqueIdProperty, options }) {
...
function calculateFeatures({ map, tileIsFullyVisible, geometryIntersection, data, type, bbox, tileFormat, uniqueIdProperty, options }) {
...
function addAllFeaturesInTile({ map, data, type, bbox, tileFormat, uniqueIdProperty, options }) {
    const indices = getIndices(data);
    const storeGeometry = (options == null ? void 0 : options.storeGeometry) || false;
    for(let i = 0; i < indices.length - 1; i++){
        const startIndex = indices[i];
...
function tileFeaturesSpatialIndex({ tiles, spatialFilter, spatialDataColumn, spatialDataType }) {
    const map = new Map();
...
function getResolution(tiles, spatialIndex) {
    ...
    if (spatialIndex === SpatialIndex.H3) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$h3$2d$js$2f$dist$2f$browser$2f$h3$2d$js$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getResolution"])(data[0].id);
    }
}
const bboxWest = [
    -180,
...
function getCellsCoverGeometry(geometry, spatialIndex, resolution) {
    ...
    if (spatialIndex === SpatialIndex.H3) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$h3$2d$js$2f$dist$2f$browser$2f$h3$2d$js$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["polygonToCells"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometry, bboxWest).geometry.coordinates, resolution, true).concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$h3$2d$js$2f$dist$2f$browser$2f$h3$2d$js$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["polygonToCells"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometry, bboxEast).geometry.coordinates, resolution, true));
    }
}
 ...
 * @internal
 */ /** @internal */ const V3_MINOR_VERSION = '3.4';
/** @privateRemarks Source: @carto/constants, @deck.gl/carto */ const DEFAULT_GEO_COLUMN = 'geom';
/**
 * Fastly default limit is 8192; leave some padding.
 * @privateRemarks Source: @deck.gl/carto
 */ const DEFAULT_MAX_LENGTH_URL = 7000;
/** @privateRemarks Source: @deck.gl/carto */ const DEFAULT_TILE_RESOLUTION = 0.5;
/**
 * @privateRemarks Source: @deck.gl/carto
 * @internal
...
/** @privateRemarks Source: @carto/react-core */ function tileFeatures({ tiles, spatialFilter, uniqueIdProperty, tileFormat, spatialDataColumn = DEFAULT_GEO_COLUMN, spatialDataType, options = {} }) {
...
/** @internal */ function getFiltersByType(filters) {
...
/** @internal */ function getFilterRange(timeFilter, filterSize) {
    const result = Array(filterSize).fill([
        0,
        0
    ]);
...
/** @internal */ function getUpdateTriggers(filtersWithoutTimeType, timeColumn, timeFilter) {
...
/** @internal */ function getFilterValue(filtersWithoutTimeType, timeColumn, timeFilter, filterSize, filtersLogicalOperator) {
...
/** @privateRemarks Source: @carto/react-core */ function assert(condition, message) {
    if (!condition) {
...
/** @internal */ const isObject = (x)=>x !== null && typeof x === 'object';
/** @internal */ const isPureObject = (x)=>isObject(x) && x.constructor === ({}).constructor;
/**
 ...
 */ function createViewportSpatialFilter(viewport) {
    ...
    return createPolygonSpatialFilter((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$polygon$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(viewport).geometry);
}
/**
 ...
 */ function _normalizeGeometry(geometry) {
    ...
    const worldClip = _clean((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometry, WORLD).geometry);
    const geometryTxWest = _tx(geometry, 360);
    const geometryTxEast = _tx(geometry, -360);
    let result = worldClip;
    if (result && geometryTxWest) {
        const worldWestClip = _clean((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometryTxWest, WORLD).geometry);
        if (worldWestClip) {
            const collection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["featureCollection"])([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["feature"])(result),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["feature"])(worldWestClip)
            ]);
            const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$union$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(collection);
            result = merged ? _clean(merged.geometry) : result;
        }
    }
    if (result && geometryTxEast) {
        const worldEastClip = _clean((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$bbox$2d$clip$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(geometryTxEast, WORLD).geometry);
        if (worldEastClip) {
            const collection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["featureCollection"])([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["feature"])(result),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["feature"])(worldEastClip)
            ]);
            const merged = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$union$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(collection);
            result = merged ? _clean(merged.geometry) : result;
        }
...
/** @privateRemarks Source: @carto/react-core */ function _cleanPolygonCoords(cc) {
    const coords = cc.filter((c)=>c.length > 0);
    return coords.length > 0 ? coords : null;
}
/** @privateRemarks Source: @carto/react-core */ function _cleanMultiPolygonCoords(ccc) {
    const coords = ccc.map(_cleanPolygonCoords).filter((cc)=>cc);
    return coords.length > 0 ? coords : null;
}
/** @privateRemarks Source: @carto/react-core */ function _clean(geometry) {
    if (!geometry) {
        return null;
    }
    if (_isPolygon(geometry)) {
        const coords = _cleanPolygonCoords(geometry.coordinates);
        return coords ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["polygon"])(coords).geometry : null;
    }
    if (_isMultiPolygon(geometry)) {
        const coords = _cleanMultiPolygonCoords(geometry.coordinates);
        return coords ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["multiPolygon"])(coords).geometry : null;
    }
    return null;
}
/** @privateRemarks Source: @carto/react-core */ function _txContourCoords(cc, distance) {
    return cc.map((c)=>[
            c[0] + distance,
            c[1]
        ]);
}
/** @privateRemarks Source: @carto/react-core */ function _txPolygonCoords(ccc, distance) {
    return ccc.map((cc)=>_txContourCoords(cc, distance));
}
/** @privateRemarks Source: @carto/react-core */ function _txMultiPolygonCoords(cccc, distance) {
    return cccc.map((ccc)=>_txPolygonCoords(ccc, distance));
}
/** @privateRemarks Source: @carto/react-core */ function _tx(geometry, distance) {
    if (geometry && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$invariant$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getType"])(geometry) === 'Polygon') {
        const coords = _txPolygonCoords(geometry.coordinates, distance);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["polygon"])(coords).geometry;
    } else if (geometry && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$invariant$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getType"])(geometry) === 'MultiPolygon') {
        const coords = _txMultiPolygonCoords(geometry.coordinates, distance);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$helpers$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["multiPolygon"])(coords).geometry;
    } else {
        return null;
    }
}
function _isPolygon(geometry) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$invariant$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getType"])(geometry) === 'Polygon';
}
function _isMultiPolygon(geometry) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$invariant$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getType"])(geometry) === 'MultiPolygon';
}
// deck.gl
// SPDX-License-Identifier: MIT
// Copyright (c) vis.gl contributors
...
/** @internal Required by fetchMap(). */ function buildPublicMapUrl({ apiBaseUrl, cartoMapId }) {
    return buildV3Path(apiBaseUrl, 'v3', 'maps', 'public', cartoMapId);
}
/** @internal Required by fetchMap(). */ function buildStatsUrl({ attribute, apiBaseUrl, connectionName, source, type }) {
    if (type === 'query') {
 ...
 */ class CartoAPIError extends Error {
    constructor(error, errorContext, response, responseJson){
        ...
        message += '\n';
        super(message);
        /** Source error from server */ this.error = void 0;
        /** Context (API call & parameters) in which error occured */ this.errorContext = void 0;
        /** Response from server */ this.response = void 0;
        /** JSON Response from server */ this.responseJson = void 0;
...
async function requestWithParameters({ baseUrl, parameters = {}, headers: customHeaders = {}, errorContext, maxLengthURL = DEFAULT_MAX_LENGTH_URL, localCache }) {
    ...
    const { cache: REQUEST_CACHE, canReadCache, canStoreInCache } = getCacheSettings(localCache);
    ...
    /* global fetch */ const fetchPromise = url.length > maxLengthURL ? fetch(baseUrl, {
        method: 'POST',
...
async function baseSource(endpoint, options, urlParameters) {
    const { accessToken, connectionName, cache } = options, optionalOptions = _objectWithoutPropertiesLoose(options, _excluded$1);
 ...
 */ function dealWithApiError({ response, data }) {
...
/** @privateRemarks Source: @carto/react-api */ async function makeCall({ url, accessToken, opts }) {
    let response;
    let data;
...
/** @privateRemarks Source: @carto/react-api */ const AVAILABLE_MODELS = [
    'category',
    'histogram',
    'formula',
    'pick',
 ...
 */ function executeModel(props) {
    ...
    const { data, filters, filtersLogicalOperator = 'and', spatialDataType = 'geo', spatialFiltersMode = 'intersects' } = source;
    const queryParams = {
        type,
        client: clientId,
        source: data,
 ...
 */ class WidgetRemoteSource extends WidgetSource {
    async getCategories(options) {
        const { signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded);
    ...
    async getFeatures(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded2);
    ...
    async getFormula(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode, operationExp } = options, params = _objectWithoutPropertiesLoose(options, _excluded3);
    ...
    async getHistogram(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded4);
    ...
    async getRange(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded5);
        const { column } = params;
        return executeModel({
            model: 'range',
            source: _extends({}, this.getModelSource(filters, filterOwner), {
    ...
    async getScatter(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded6);
        ...
        }).then((res)=>normalizeObjectKeys(res.rows)).then((res)=>res.map(({ x, y })=>[
                    x,
                    y
                ]));
    }
    async getTable(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded7);
    ...
    async getTimeSeries(options) {
        const { abortController, signal = abortController == null ? void 0 : abortController.signal, filters = this.props.filters, filterOwner, spatialFilter, spatialFiltersMode } = options, params = _objectWithoutPropertiesLoose(options, _excluded8);
        const { column, operationColumn, joinOperation, operation, stepSize, stepMultiplier, splitByCategory, splitByCategoryLimit, splitByCategoryValues } = params;
        return executeModel({
            model: 'timeseries',
            source: _extends({}, this.getModelSource(filters, filterOwner), {
                spatialFiltersMode,
...
/** @privateRemarks Source: @carto/react-core */ const aggregationFunctions = {
...
/** @privateRemarks Source: @carto/react-core */ function aggregate(feature, keys, operation) {
...
function normalizeKeys(keys) {
    return Array.isArray(keys) ? keys : typeof keys === 'string' ? [
        keys
    ] : undefined;
}
/***
...
*/ var thenBy_module = function() {
    ...
    /* adds a secondary compare function to the target function (`this` context)
     ...
     returns a new compare function, which has a `thenBy` method as well */ function tb(func, opt) {
 ...
 * @internal
 * @privateRemarks Source: @carto/react-core
 */ function applySorting(features, { sortBy, sortByDirection = 'asc', sortByColumnType = 'string' } = {}) {
...
// Aux
function createSortFn({ sortBy, sortByDirection, sortByColumnType }) {
...
function normalizeSortByOptions({ sortBy, sortByDirection, sortByColumnType }) {
...
/** @privateRemarks Source: @carto/react-core */ function groupValuesByColumn({ data, valuesColumns, joinOperation, keysColumn, operation }) {
...
/** @privateRemarks Source: @carto/react-core */ function groupValuesByDateColumn({ data, valuesColumns, joinOperation, keysColumn, groupType, operation }) {
    if (Array.isArray(data) && data.length === 0) {
        return null;
    }
 ...
 * @privateRemarks Source: @carto/react-core
 */ function histogram({ data, valuesColumns, joinOperation, ticks, operation }) {
    if (Array.isArray(data) && data.length === 0) {
        return [];
    }
    const binsContainer = [
 ...
 * @privateRemarks Source: @carto/react-core
 */ function scatterPlot({ data, xAxisColumns, xAxisJoinOperation, yAxisColumns, yAxisJoinOperation }) {
 ...
 */ class WidgetTilesetSource extends WidgetSource {
   ...
   */ loadTiles(tiles) {
    ...
    /** Configures options used to extract features from tiles. */ setTileFeatureExtractOptions(options) {
    ...
    _extractTileFeatures(spatialFilter) {
        ...
        if (this._features.length && prevInputs.spatialFilter && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$turf$2f$boolean$2d$equal$2f$dist$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["booleanEqual"])(prevInputs.spatialFilter, spatialFilter)) {
            return;
        }
   ...
   */ loadGeoJSON({ geojson, spatialFilter }) {
    ...
    async getFormula({ column = '*', operation = 'count', joinOperation, filters, filterOwner, spatialFilter }) {
        if (operation === 'custom') {
    ...
    async getHistogram({ operation = 'count', ticks, column, joinOperation, filters, filterOwner, spatialFilter }) {
        const filteredFeatures = this._getFilteredFeatures(spatialFilter, filters, filterOwner);
        assertColumn(this._features, column);
    ...
    async getCategories({ column, operation = 'count', operationColumn, joinOperation, filters, filterOwner, spatialFilter }) {
        const filteredFeatures = this._getFilteredFeatures(spatialFilter, filters, filterOwner);
    ...
    async getScatter({ xAxisColumn, yAxisColumn, xAxisJoinOperation, yAxisJoinOperation, filters, filterOwner, spatialFilter }) {
        const filteredFeatures = this._getFilteredFeatures(spatialFilter, filters, filterOwner);
        if (!filteredFeatures.length) {
            return [];
        }
    ...
    async getTable({ columns, searchFilterColumn, searchFilterText, sortBy, sortDirection, sortByColumnType, offset = 0, limit = 10, filters, filterOwner, spatialFilter }) {
        // Filter.
    ...
    async getTimeSeries({ column, stepSize, operation, operationColumn, joinOperation, filters, filterOwner, spatialFilter }) {
        const filteredFeatures = this._getFilteredFeatures(spatialFilter, filters, filterOwner);
        if (!filteredFeatures.length) {
            return {
                rows: []
    ...
    async getRange({ column, filters, filterOwner, spatialFilter }) {
        assertColumn(this._features, column);
        const filteredFeatures = this._getFilteredFeatures(spatialFilter, filters, filterOwner);
        if (!this._features.length) {
...
function normalizeColumns(columns) {
    return Array.isArray(columns) ? columns : typeof columns === 'string' ? [
        columns
    ] : [];
}
...
const vectorQuerySource = async function vectorQuerySource(options) {
    const { columns, filters, spatialDataColumn = DEFAULT_GEO_COLUMN, sqlQuery, tileResolution = DEFAULT_TILE_RESOLUTION, queryParameters, aggregationExp } = options;
...
const vectorTableSource = async function vectorTableSource(options) {
    const { columns, filters, spatialDataColumn = DEFAULT_GEO_COLUMN, tableName, tileResolution = DEFAULT_TILE_RESOLUTION, aggregationExp } = options;
    const spatialDataType = 'geo';
    const urlParameters = {
        name: tableName,
        spatialDataColumn,
...
const query = async function query(options) {
    const { apiBaseUrl = SOURCE_DEFAULTS.apiBaseUrl, maxLengthURL = SOURCE_DEFAULTS.maxLengthURL, clientId = getClient(), localCache, connectionName, sqlQuery, queryParameters } = options;
    const urlParameters = {
        q: sqlQuery
    };
    if (queryParameters) {
...
//# sourceMappingURL=node_modules_%40carto_api-client_build_api-client_modern_70a7c300.js.map