(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_wgsl_reflect_wgsl_reflect_module_373f8efb.js", {

"[project]/node_modules/wgsl_reflect/wgsl_reflect.module.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const d = new Float32Array(1), m = new Int32Array(d.buffer), _ = new Uint16Array(1);
function g(e) {
    d[0] = e;
    const t = m[0], n = t >> 31 & 1;
...
const x = new Uint32Array(1), y = new Float32Array(x.buffer, 0, 1);
function b(e) {
...
function v(e, t, n, s, r, a, i, o, l) {
    ...
    switch(l){
        ...
        case 'rg11b10ufloat':
            {
                const t = new Uint32Array(e.buffer, c, 1)[0], n = (4192256 & t) >> 11, s = (4290772992 & t) >> 22;
                return [
                    b(2047 & t),
                    b(n),
                    function(e) {
...
se.x32 = new se('x32'), se.f32 = new se('f32'), se.i32 = new se('i32'), se.u32 = new se('u32'), se.f16 = new se('f16'), se.bool = new se('bool'), se.void = new se('void'), se._priority = new Map([
    [
        'f32',
        0
    ],
...
class Be extends Ce {
    ...
    getSubData(e, t, n) {
        ...
        if (this.typeInfo instanceof r) s = this.typeInfo.format || s;
        else {
            const t = this.typeInfo.name;
...
class Fe extends Ce {
    ...
    getSubData(e, t, n) {
        ...
        if (e.getTypeInfo('f32'), this.typeInfo instanceof r) this.typeInfo.format;
        ...
        if (t instanceof ye) {
            ...
            let o;
            if ('mat2x2' === s || 'mat2x2f' === s || 'mat2x2h' === s || 'mat3x2' === s || 'mat3x2f' === s || 'mat3x2h' === s || 'mat4x2' === s || 'mat4x2f' === s || 'mat4x2h' === s) o = new Be(new Float32Array(this.data.buffer, this.data.byteOffset + 2 * a * 4, 2), e.getTypeInfo(`vec2${i}`));
            else if ('mat2x3' === s || 'mat2x3f' === s || 'mat2x3h' === s || 'mat3x3' === s || 'mat3x3f' === s || 'mat3x3h' === s || 'mat4x3' === s || 'mat4x3f' === s || 'mat4x3h' === s) o = new Be(new Float32Array(this.data.buffer, this.data.byteOffset + 3 * a * 4, 3), e.getTypeInfo(`vec3${i}`));
            else {
...
class Me extends Ce {
    ...
    setDataValue(t, r, a, i) {
        ...
        let o = this.offset, l = this.typeInfo;
        for(; a;){
            if (a instanceof ye) if (l instanceof s) {
                const e = a.index;
                if (e instanceof _e) {
    ...
    getSubData(t, a, i) {
        ...
        for(; a;){
            if (a instanceof ye) {
                const e = a.index, n = t.evalExpression(e, i);
                let r = 0;
                if (n instanceof Ve ? r = n.value : console.error('GetDataValue: Invalid index type', e), h instanceof s) u += r * h.stride, h = h.format;
                else {
...
class Ue extends Ce {
    ...
    getGpuSize() {
        const e = this.format, t = I[e], n = this.width;
        if (!e || n <= 0 || !t) return -1;
    ...
    setPixel(e, t, n, s, r) {
        const a = this.texelByteSize, i = this.bytesPerRow, o = this.height, l = this.data[s];
...
W = We, We.none = new Pe('', q.reserved, ''), We.eof = new Pe('EOF', q.token, ''), We.reserved = {
    ...
    W.keywords.function,
    W.keywords.private,
    W.keywords.workgroup,
    W.keywords.uniform,
    W.keywords.storage
], We.access_mode = [
    W.keywords.read,
    W.keywords.write,
    W.keywords.read_write
], We.sampler_type = [
    W.keywords.sampler,
    W.keywords.sampler_comparison
], We.sampled_texture_type = [
    W.keywords.texture_1d,
    W.keywords.texture_2d,
    W.keywords.texture_2d_array,
    W.keywords.texture_3d,
    W.keywords.texture_cube,
    W.keywords.texture_cube_array
], We.multisampled_texture_type = [
    W.keywords.texture_multisampled_2d
], We.storage_texture_type = [
    W.keywords.texture_storage_1d,
    W.keywords.texture_storage_2d,
    W.keywords.texture_storage_2d_array,
    W.keywords.texture_storage_3d
], We.depth_texture_type = [
    W.keywords.texture_depth_2d,
    W.keywords.texture_depth_2d_array,
    W.keywords.texture_depth_cube,
    W.keywords.texture_depth_cube_array,
    W.keywords.texture_depth_multisampled_2d
], We.texture_external_type = [
    W.keywords.texture_external
], We.any_texture_type = [
    ...W.sampled_texture_type,
    ...W.multisampled_texture_type,
    ...W.storage_texture_type,
    ...W.depth_texture_type,
    ...W.texture_external_type
], We.texel_format = [
    W.keywords.r8unorm,
    W.keywords.r8snorm,
    W.keywords.r8uint,
    ...
    W.keywords.rg16uint,
    W.keywords.rg16sint,
    W.keywords.rg16float,
    W.keywords.rgba8unorm,
    W.keywords.rgba8unorm_srgb,
    W.keywords.rgba8snorm,
    W.keywords.rgba8uint,
    W.keywords.rgba8sint,
    W.keywords.bgra8unorm,
    W.keywords.bgra8unorm_srgb,
    W.keywords.rgb10a2unorm,
    W.keywords.rg11b10float,
    W.keywords.rg32uint,
    W.keywords.rg32sint,
    W.keywords.rg32float,
    W.keywords.rgba16uint,
    W.keywords.rgba16sint,
    W.keywords.rgba16float,
    W.keywords.rgba32uint,
    W.keywords.rgba32sint,
    W.keywords.rgba32float
], We.const_literal = [
    W.tokens.int_literal,
    W.tokens.uint_literal,
    W.tokens.decimal_float_literal,
    W.tokens.hex_float_literal,
    W.keywords.true,
    W.keywords.false
], We.literal_or_ident = [
    W.tokens.ident,
    ...
    W.tokens.ident,
    W.keywords.block,
    W.keywords.diagnostic
], We.assignment_operators = [
    W.tokens.equal,
    W.tokens.plus_equal,
    W.tokens.minus_equal,
    W.tokens.times_equal,
...
const Re = new Float32Array(1), Ge = new Uint32Array(Re.buffer), Xe = new Uint32Array(Re.buffer), je = new Int32Array(1), Ze = new Float32Array(je.buffer), Qe = new Uint32Array(je.buffer), Ye = new Uint32Array(1), Ke = new Float32Array(Ye.buffer), Je = new Int32Array(Ye.buffer);
function et(e, t, n) {
    if (t === n) return e;
    if ('f32' === t) {
...
class st {
    ...
    updateAST(e) {
        ...
        for (const t of e)if (t instanceof J) this.aliases.push(this._getAliasInfo(t));
            ...
            const e = t, n = this._getAttributeNum(e.attributes, 'group', 0), s = this._getAttributeNum(e.attributes, 'binding', 0), r = this.getTypeInfo(e.type, e.attributes), o = new i(e.name, r, n, s, e.attributes, a.Uniform, e.access);
            o.access || (o.access = 'read'), this.uniforms.push(o);
        } else if (this._isStorageVar(t)) {
            const e = t, n = this._getAttributeNum(e.attributes, 'group', 0), s = this._getAttributeNum(e.attributes, 'binding', 0), r = this.getTypeInfo(e.type, e.attributes), o = this._isStorageTexture(r), l = new i(e.name, r, n, s, e.attributes, o ? a.StorageTexture : a.Storage, e.access);
            l.access || (l.access = 'read'), this.storage.push(l);
        } else if (this._isTextureVar(t)) {
            const e = t, n = this._getAttributeNum(e.attributes, 'group', 0), s = this._getAttributeNum(e.attributes, 'binding', 0), r = this.getTypeInfo(e.type, e.attributes), o = this._isStorageTexture(r), l = new i(e.name, r, n, s, e.attributes, o ? a.StorageTexture : a.Texture, e.access);
            l.access || (l.access = 'read'), o ? this.storage.push(l) : this.textures.push(l);
        } else if (this._isSamplerVar(t)) {
            const e = t, n = this._getAttributeNum(e.attributes, 'group', 0), s = this._getAttributeNum(e.attributes, 'binding', 0), r = this.getTypeInfo(e.type, e.attributes), o = new i(e.name, r, n, s, e.attributes, a.Sampler, e.access);
            this.samplers.push(o);
        } else if (t instanceof L) {
            const e = this._getAttribute(t, 'vertex'), n = this._getAttribute(t, 'fragment'), s = this._getAttribute(t, 'compute'), r = e || n || s, a = new f(t.name, null == r ? void 0 : r.name, t.attributes);
        ...
        for (const e of this._functions.values())e.node.search((t)=>{
            var n, s, r;
            if (t instanceof Le) {
                if (t.value) if (ze(t.value)) for (const s of t.value)for (const t of this.overrides)s === t.name && (null === (n = e.info) || void 0 === n || n.overrides.push(t));
    ...
    _findResources(e, t) {
        const n = [], s = this, r = [];
        return e.search((a)=>{
            if (a instanceof S) r.push({});
            else if (a instanceof A) r.pop();
    ...
    _getOutputs(e, t = void 0) {
        if (void 0 === t && (t = []), e instanceof ae) this._getStructOutputs(e, t);
        else {
    ...
    _getStructOutputs(e, t) {
        for (const n of e.members)if (n.type instanceof ae) this._getStructOutputs(n.type, t);
        else {
            const e = this._getAttribute(n, 'location') || this._getAttribute(n, 'builtin');
            if (null !== e) {
                const s = this.getTypeInfo(n.type, n.type.attributes), r = this._parseInt(e.value), a = new c(n.name, s, e.name, r);
                t.push(a);
            }
        }
    }
    ...
    _getInputs(e, t = void 0) {
        void 0 === t && (t = []);
        for (const n of e)if (n.type instanceof ae) this._getStructInputs(n.type, t);
        else {
    ...
    _getStructInputs(e, t) {
        for (const n of e.members)if (n.type instanceof ae) this._getStructInputs(n.type, t);
        else {
            const e = this._getInputInfo(n);
            null !== e && t.push(e);
        }
    ...
    getTypeInfo(a, i = null) {
        ...
        if (a instanceof le) {
            const e = a, t = e.format ? this.getTypeInfo(e.format, e.attributes) : null, n = new s(e.name, i);
            return n.format = t, n.count = e.count, this._types.set(a, n), this._updateTypeInfo(n), n;
        }
        if (a instanceof ae) {
            const e = a, s = new n(e.name, i);
        ...
        if (a instanceof ce) {
            const t = a, n = t.format instanceof se, s = t.format ? n ? this.getTypeInfo(t.format, null) : new e(t.format, null) : null, o = new r(t.name, s, i, t.access);
            return this._types.set(a, o), this._updateTypeInfo(o), o;
        }
        if (a instanceof ie) {
            const e = a, t = e.format ? this.getTypeInfo(e.format, null) : null, n = new r(e.name, t, i, e.access);
    ...
    _updateStructInfo(e) {
        ...
        for(let i = 0, o = e.members.length; i < o; ++i){
            const o = e.members[i], l = this._getTypeSize(o);
            if (!l) continue;
            null !== (t = this._getAlias(o.type.name)) && void 0 !== t || o.type;
            const c = l.align, u = l.size;
    ...
    _getTypeSize(r) {
        ...
        const o = this._getAttributeNum(r.attributes, 'size', 0), l = this._getAttributeNum(r.attributes, 'align', 0);
...
class lt {
    ...
    TextureStore(e, t) {
        ...
        if (n instanceof de) {
            ...
            if (o instanceof Ue) {
                const t = o.getMipLevelSize(0), n = Math.floor(s.data[0]), l = Math.floor(s.data[1]);
    ...
    AtomicAdd(e, t) {
        ...
        const s = this.exec.getVariableName(n, t), r = t.getVariable(s);
        let a = e.args[1];
        const i = this.exec.evalExpression(a, t), o = r.value.getSubData(this.exec, n.postfix, t), l = new Ve(o.value, o.typeInfo);
...
class ht extends ot {
    ...
    dispatchWorkgroups(e, t, n, s) {
        ...
        const i = t[0], o = t[1], l = t[2], c = this.getTypeInfo('vec3u');
        ...
        for(let e = 0; e < l; ++e)for(let t = 0; t < o; ++t)for(let n = 0; n < i; ++n)r.setVariable('@workgroup_id', new Be([
            n,
            t,
            e
    ...
    execStatement(e, t) {
        ...
        if (e instanceof F) this._let(e, t);
        else if (e instanceof O) this._var(e, t);
        else if (e instanceof M) this._const(e, t);
        else if (e instanceof L) this._function(e, t);
        else {
            ...
            if (e instanceof z) this._assign(e, t);
            else if (e instanceof H) this._increment(e, t);
            else {
                if (e instanceof ae) return null;
                if (e instanceof B) {
                    const n = e.name;
                    null === t.getVariable(n) && t.setVariable(n, new Ve(0, this.getTypeInfo('u32')));
                } else if (e instanceof R) this._call(e, t);
                else {
    ...
    _assign(e, t) {
        ...
        if ('=' === i) if (n instanceof Me) n.setDataValue(this, a, r, t);
        else if (r) {
    ...
    _evalCreate(e, t) {
        ...
        const a = e instanceof fe ? e.type.name : e.name, i = e instanceof fe ? this.getTypeInfo(e.type) : this.getTypeInfo(e.name);
        ...
        if (i instanceof n) {
            ...
            if (e.args) for(let s = 0; s < e.args.length; ++s){
                const a = e.args[s], l = this.evalExpression(a, t);
    ...
    _evalBinaryOp(e, t) {
        const n = this.evalExpression(e.left, t), s = this.evalExpression(e.right, t), r = n instanceof Ve ? n.value : n instanceof Be || n instanceof Fe ? Array.from(n.data) : null, a = s instanceof Ve ? s.value : s instanceof Be || s instanceof Fe ? Array.from(s.data) : null;
        switch(e.operator){
            case '+':
                {
                    if (ze(r) && ze(a)) {
                    ...
                    if (ze(r) && ze(a)) {
                        ...
                        if (n instanceof Fe && s instanceof Fe) {
                            const r = function(e, t, n, s) {
                                ...
                                const r = ut[t.name][0], a = ut[t.name][1], i = ut[s.name][0];
                            ...
                            const a = ut[s.typeInfo.name][0], o = ut[n.typeInfo.name][1], l = this.getTypeInfo(`mat${a}x${o}f`);
                            return new Fe(r, l);
                        }
                        if (n instanceof Fe && s instanceof Be) {
                            const r = function(e, t, n, s) {
                                if (void 0 === ut[t.name] || void 0 === ct[s.name]) return null;
                                const r = ut[t.name][0], a = ut[t.name][1];
                        ...
                        if (n instanceof Be && s instanceof Fe) {
                            const r = function(e, t, n, s) {
                                ...
                                const r = ut[s.name][0], a = ut[s.name][1];
    ...
    _callConstructorVec(e, t) {
        const n = this.getTypeInfo(e.type), s = e.type.getTypeName(), r = ct[s];
        if (void 0 === r) return console.error(`Invalid vec constructor ${s}. Line ${e.line}`), null;
        const a = [];
        if (e instanceof _e) if (e.isVector) {
    ...
    _callConstructorMatrix(e, t) {
        const n = this.getTypeInfo(e.type), s = e.type.getTypeName(), a = ut[s];
...
ht._breakObj = new Ce(new e('BREAK', null), null), ht._continueObj = new Ce(new e('CONTINUE', null), null), ht._priority = new Map([
    [
        'f32',
        0
    ],
...
class pt {
    ...
    _global_decl_or_directive() {
        ...
        if (this._match(We.keywords.alias)) {
            ...
            return this._consume(We.tokens.semicolon, 'Expected \';\''), this._exec.reflection.updateAST([
                e
            ]), e;
        }
        ...
        if (this._check(We.keywords.var)) {
            ...
            return null != t && (t.attributes = e), this._consume(We.tokens.semicolon, 'Expected \';\'.'), this._exec.reflection.updateAST([
                t
            ]), t;
        }
    ...
    _function_decl() {
        ...
        const e = this._currentLine, t = this._consume(We.tokens.ident, 'Expected function name.').toString();
        ...
        if (!this._check(We.tokens.paren_right)) do {
            ...
            const e = this._attribute(), t = this._consume(We.tokens.name, 'Expected argument name.').toString();
    ...
    _statement() {
        ...
        let e = null;
        if (this._check(We.keywords.return)) e = this._return_statement();
        else if (this._check([
            We.keywords.var,
            We.keywords.let,
            We.keywords.const
        ])) e = this._variable_statement();
        else if (this._match(We.keywords.discard)) e = this._updateNode(new ee);
    ...
    _variable_statement() {
        ...
        if (this._match(We.keywords.let)) {
            const e = this._currentLine, t = this._consume(We.tokens.name, 'Expected name for let.').toString();
            let n = null;
        ...
        if (this._match(We.keywords.const)) {
            const e = this._currentLine, t = this._consume(We.tokens.name, 'Expected name for const.').toString();
            let n = null;
            if (this._match(We.tokens.colon)) {
                const e = this._attribute();
                n = this._type_decl(), null != n && (n.attributes = e);
    ...
    _assignment_statement() {
        ...
        const s = this._consume(We.assignment_operators, 'Expected assignment operator.'), r = this._short_circuit_or_expression();
        return this._updateNode(new z(P.parse(s.lexeme), e, r), t);
    }
    _func_call_statement() {
        if (!this._check(We.tokens.ident)) return null;
        const e = this._currentLine, t = this._current, n = this._consume(We.tokens.ident, 'Expected function name.'), s = this._argument_expression_list();
    ...
    _equality_expression() {
        ...
        return this._match([
            We.tokens.equal_equal,
            We.tokens.not_equal
        ]) ? this._updateNode(new we(this._previous().toString(), e, this._relational_expression())) : e;
    }
    _relational_expression() {
        let e = this._shift_expression();
        for(; this._match([
            We.tokens.less_than,
            We.tokens.greater_than,
            We.tokens.less_than_equal,
            We.tokens.greater_than_equal
        ]);)e = this._updateNode(new we(this._previous().toString(), e, this._shift_expression()));
        return e;
    }
    _shift_expression() {
        let e = this._additive_expression();
        for(; this._match([
            We.tokens.shift_left,
            We.tokens.shift_right
        ]);)e = this._updateNode(new we(this._previous().toString(), e, this._additive_expression()));
        return e;
    }
    ...
    _multiplicative_expression() {
        ...
        for(; this._match([
            We.tokens.star,
            We.tokens.forward_slash,
            We.tokens.modulo
        ]);)e = this._updateNode(new we(this._previous().toString(), e, this._unary_expression()));
        return e;
    }
    _unary_expression() {
        return this._match([
            ...
            We.tokens.star,
            We.tokens.and
        ]) ? this._updateNode(new ve(this._previous().toString(), this._unary_expression())) : this._singular_expression();
    }
    ...
    _postfix_expression() {
        if (this._match(We.tokens.bracket_left)) {
            ...
            const t = this._updateNode(new ye(e)), n = this._postfix_expression();
            return n && (t.postfix = n), t;
        }
        if (this._match(We.tokens.period)) {
            const e = this._consume(We.tokens.name, 'Expected member name.'), t = this._postfix_expression(), n = this._updateNode(new he(e.lexeme));
    ...
    _primary_expression() {
        ...
        if (this._match([
            We.tokens.decimal_float_literal,
            We.tokens.hex_float_literal
        ])) {
    ...
    _struct_decl() {
        ...
        const e = this._currentLine, t = this._consume(We.tokens.ident, 'Expected name for struct.').toString();
        this._consume(We.tokens.brace_left, 'Expected \'{\' for struct body.');
        const n = [];
        for(; !this._check(We.tokens.brace_right);){
            const e = this._attribute(), t = this._consume(We.tokens.name, 'Expected variable name.').toString();
        ...
        const s = this._currentLine, r = this._updateNode(new ae(t, n, e, s), e);
    ...
    _global_const_decl() {
        ...
        const t = this._consume(We.tokens.name, 'Expected variable name'), n = this._currentLine;
        let s = null;
        if (this._match(We.tokens.colon)) {
            const e = this._attribute();
            s = this._type_decl(), null != s && (s.attributes = e);
    ...
    _global_let_decl() {
        ...
        const e = this._currentLine, t = this._consume(We.tokens.name, 'Expected variable name');
        let n = null;
        if (this._match(We.tokens.colon)) {
            const e = this._attribute();
            n = this._type_decl(), null != n && (n.attributes = e);
    ...
    _requires_directive() {
        const e = [
            this._consume(We.tokens.ident, 'identity expected.').toString()
        ];
    ...
    _attribute() {
        ...
        for(; this._match(We.tokens.attr);){
            const t = this._consume(We.attribute_name, 'Expected attribute name'), n = this._updateNode(new Le(t.toString(), null));
...
class St {
    ...
    debugWorkgroup(e, t, n, s, r) {
        ...
        const o = n[2], l = n[1], c = n[0], u = this._exec.typeInfo.vec3u;
        ...
        let h = !1;
        for(let e = 0; e < o && !h; ++e)for(let t = 0; t < l && !h; ++t)for(let n = 0; n < c && !h; ++n)if (a.setVariable('@workgroup_id', new Be([
            n,
            t,
            e
        ], u)), this._dispatchWorkgroup(i, [
            n,
            t,
            e
        ], a)) {
    ...
    _createState(e, t, n) {
        ...
        for (const t of e)if (t instanceof F || t instanceof O || t instanceof M || t instanceof z) {
            ...
            for (const n of e)s.commands.push(new gt(n, t));
            s.commands.push(new _t(t));
        } else if (t instanceof H) s.commands.push(new _t(t));
        else {
            if (t instanceof L) {
                const e = new at(t);
            ...
            if (t instanceof j) {
                ...
                for (const e of t.cases){
                    ...
                    if (e instanceof Te) {
                        for (const t of e.selectors)if (t instanceof Ie) {
                            n = e;
                            break;
                        }
                    }
    ...
    _collectFunctionCalls(e, t) {
        ...
        } else if (e instanceof we) this._collectFunctionCalls(e.left, t), this._collectFunctionCalls(e.right, t);
        else if (e instanceof ve) this._collectFunctionCalls(e.right, t);
...
//# sourceMappingURL=node_modules_wgsl_reflect_wgsl_reflect_module_373f8efb.js.map