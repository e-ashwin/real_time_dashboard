(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/[root of the server]__bed9234f._.js", {
...
const LiveDataCards = ({ data })=>{
    console.log("🔹 LiveDataCards Received Data:", data); // ✅ Debug log
        ...
        "Dashboard.useEffect": ()=>{
            ...
            socket.onmessage = ({
                "Dashboard.useEffect": (event)=>{
                    ...
                    console.log("🔹 New Data Received:", newData); // ✅ Debugging
                    setData({
...
_s(Dashboard, "2XnAGoFe5+bWreUR1Lbbnyvvrdo=");
_c = Dashboard;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__bed9234f._.js.map