(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_h3-js_dist_browser_h3-js_es_dcf84dfc.js", {
...
__turbopack_context__.s({
    "UNITS": (()=>UNITS),
    "areNeighborCells": (()=>areNeighborCells),
    "cellArea": (()=>cellArea),
    "cellToBoundary": (()=>cellToBoundary),
    "cellToCenterChild": (()=>cellToCenterChild),
    "cellToChildPos": (()=>cellToChildPos),
    "cellToChildren": (()=>cellToChildren),
    "cellToChildrenSize": (()=>cellToChildrenSize),
    ...
    "cellsToDirectedEdge": (()=>cellsToDirectedEdge),
    "cellsToMultiPolygon": (()=>cellsToMultiPolygon),
    "childPosToCell": (()=>childPosToCell),
    "compactCells": (()=>compactCells),
    "degsToRads": (()=>degsToRads),
    "directedEdgeToBoundary": (()=>directedEdgeToBoundary),
    "directedEdgeToCells": (()=>directedEdgeToCells),
    "edgeLength": (()=>edgeLength),
    "getBaseCellNumber": (()=>getBaseCellNumber),
    "getDirectedEdgeDestination": (()=>getDirectedEdgeDestination),
    "getDirectedEdgeOrigin": (()=>getDirectedEdgeOrigin),
    "getHexagonAreaAvg": (()=>getHexagonAreaAvg),
    "getHexagonEdgeLengthAvg": (()=>getHexagonEdgeLengthAvg),
    "getIcosahedronFaces": (()=>getIcosahedronFaces),
    "getNumCells": (()=>getNumCells),
    "getPentagons": (()=>getPentagons),
    ...
    "isResClassIII": (()=>isResClassIII),
    "isValidCell": (()=>isValidCell),
    "isValidDirectedEdge": (()=>isValidDirectedEdge),
    "isValidVertex": (()=>isValidVertex),
    "latLngToCell": (()=>latLngToCell),
    "localIjToCell": (()=>localIjToCell),
    "originToDirectedEdges": (()=>originToDirectedEdges),
...
//# sourceMappingURL=node_modules_h3-js_dist_browser_h3-js_es_dcf84dfc.js.map