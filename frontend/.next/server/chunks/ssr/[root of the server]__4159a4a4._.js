...
const TimeSeriesAnalysis = ({ data })=>{
    ...
    const theme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mui$2f$material$2f$styles$2f$useTheme$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__useTheme$3e$__["useTheme"])();
    const filterDataByTimeRange = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])((data, range)=>{
        const now = new Date();
    ...
    const groupData = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])((filteredData, range)=>{
        const groups = {};
...
const ForecastComponent = ({ historicalData })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (historicalData?.length > 0) {
            ...
            const weightedSum = recentData.slice(-4).reduce((sum, val, i)=>sum + val * (weights[i] || 0.1), 0);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4159a4a4._.js.map