...
(()=>{
    const e = new Error("Cannot find module '@deck.gl/geo-layers'");
...
([__TURBOPACK__imported__module__$5b$externals$5d2f40$deck$2e$gl$2f$react__$5b$external$5d$__$2840$deck$2e$gl$2f$react$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
;
;
const MAPBOX_TOKEN = "YOUR_MAPBOX_ACCESS_TOKEN"; // Replace with your token
const WindMap = ()=>{
    const windData = "https://example.com/wind-data.json"; // Replace with real wind data source
    const layers = [
        new WindLayer({
            id: "wind-layer",
            data: windData,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__837352ae._.js.map